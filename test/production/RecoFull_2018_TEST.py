...
# with command line options: step3 --conditions 101X_upgrade2018_realistic_forJetMetHLT -n 10 --era Run2_2018 --eventcontent RECOSIM,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,EI,PAT:@standardValidation+@miniAODValidation,DQM:@standardDQM+@ExtraHLT+@miniAODDQM --datatier RECO,MINIAODSIM,DQMIO --geometry DB:Extended --python RecoFull_2018_TEST.py --filein file:step2.root --fileout file:step3.root --nThreads 8 --data
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/relval/CMSSW_10_2_5/RelValQCD_FlatPt_15_3000HS_13/GEN-SIM-DIGI-RAW/102X_upgrade2018_realistic_v12_Can30fb_v1-v1/10000/10989D9A-3927-CE45-90D1-9D7F5E13F404.root'),
